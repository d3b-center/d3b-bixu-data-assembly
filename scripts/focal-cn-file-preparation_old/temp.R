...
# Set path to results directory
analysis_dir <- file.path("/scripts/focal-cn-file-preparation")
...
histologies_df <- read_csv(metadata,col_types = cols(molecular_subtype = col_character()))
