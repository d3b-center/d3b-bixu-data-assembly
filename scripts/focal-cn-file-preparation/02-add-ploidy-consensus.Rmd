...
consensus_seg_file <- file.path("..", "copy_number_consensus_call", "results", 
                                "PNOC003-26-cell-line-PNOC008-29-cnv-consensus.seg.gz")
#histologies_file <- file.path("..", "..", "data","pnoc008" , "PNOC008-histologies-mock.tsv")

histologies_file <- file.path("/Users/zhangb1/Documents/Kid-First/project/Re-Harmonization/GH-PNOC008/merged_files/PNOC008-29/mock.hist")
