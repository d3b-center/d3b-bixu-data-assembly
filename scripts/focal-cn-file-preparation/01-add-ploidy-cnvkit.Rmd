...
```{r}
cnvkit_file <- file.path("..", "..", "data", "pbta_v17","PNOC008-WXS-cnv-cnvkit.tsv.gz")
cnvkit_df <- readr::read_tsv(cnvkit_file)
```

```{r}
histologies_file <- file.path("..", "..", "data","pbta_0515","histo_files" ,"all_pnoc_pbta_add_gender_ploidy.tsv")
