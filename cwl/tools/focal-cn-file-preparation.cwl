...
arguments:
  - position: 0
    shellQuote: false
    valueFrom: >-
        /d3b-bixu-data-assembly/scripts/focal-cn-file-preparation/02-add-ploidy-consensus.R --scratch ./scratch --consensus_seg_file  $(inputs.consensus_seg_file.path) --histology_file $(inputs.histology_file.path) &&
